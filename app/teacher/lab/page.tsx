...
const tools=[
 ...
 {id:"xo",icon:Grid3X3,title:"إكس / أو",tag:"الاختيار المقصود",desc:"أنشئ لوحة خيارات هادفة للمهام والمنتجات، مرتبطة بالجاهزية والاهتمامات والقدرات.",action:"صمّم لوحة اختيار",ready:true},
 {id:"classroom",icon:UsersRound,title:"إدارة الصف المتمايز",tag:"التنفيذ",desc:"حوّل التصميم إلى مجموعات وأدوار ووقت ومحطات قابلة للتنفيذ داخل الحصة.",action:"خطط تشغيل الحصة",ready:true},
];
