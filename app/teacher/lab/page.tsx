...
const tools=[
 ...
 {id:"bloom",icon:BrainCircuit,title:"بلوم المعدل",tag:"عمق التفكير",desc:"حوّل الهدف إلى خبرات وأسئلة تختلف في مستوى العملية المعرفية مع بقاء التعلم المقصود واضحًا.",action:"قريبًا",ready:false},
 {id:"venn",icon:GitCompareArrows,title:"أشكال فن",tag:"المحتوى والعملية",desc:"صمّم المقارنة بدرجات مختلفة من التعقيد بحسب ما يستطيع المتعلم معالجته.",action:"قريبًا",ready:false},
